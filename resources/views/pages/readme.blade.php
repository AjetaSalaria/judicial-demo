@extends('layouts.auth_navigation') @section('title', 'Read Me -TranscriptMinerSM') @section('content')
<div id="bodyWrapper" class="bodyBackground">
    <div class="container-fluid search-container search-section-block">
        <style>
        .judicial-sec h5, .judicial-sec h4 {
...
<div class="row justify-content-center">
    <div class="col-lg-8">
         <div class="judicial-sec">
            <h5>You are testing a prototype with limited features.  Please note the following:</h5>

            <ul>
              <li>
                 For this test, only the <span>search</span> functions are enabled (see below for features to be added later).  You are able to use the search queries you are used to: keyword, Boolean terms and connectors, and natural language search.  “Soundex” search is also enabled (Soundex is a search function that returns results based on the phonetic sound of your search criteria (homophones) as opposed to the traditional exact match).  Future versions of TranscriptMiner<sup>SM</sup> will also include “semantic search,” which will return results based on context even if your exact keyword or search term does not appear in a transcript.
              </li>
              <li>
                For this test, the database is limited: it contains all of the available transcripts from the first day hearings of Bankruptcy Judge David R. Jones (SDTX) since he took the bench in 2009 (commercial chapter 11 cases only)—so you can see what Judge Jones has said about various first day motions since Day 1. (Future versions will expand first to the active judges in the districts where the most commercial chapter 11 cases are filed, and then to other active judges in other districts.  Chapter 15 cases will also be added.)
              </li>
              <li>
                You’ll note that various tabs and links in the user interface will not be functional for the test.
              </li>
              <li>
                <span>PLEASE PROVIDE YOUR COMMENTS, SUGGESTIONS AND OTHER FEEDBACK.</span>  There is a button on the home page <a href="http://www.transcriptminer.net/"><span>(www.transcriptminer.net)</span></a> which links to a text box where you can type unlimited text.  We will incorporate your feedback into the product.
              </li>
              <li>
                Although this is a test, you certainly may use the results for client work if applicable. The caveat is, although you must use your own judgement, it is <span>not</span> recommended that you use TranscriptMiner<sup>SM</sup> to tell the judge what he has said—either in your brief or your oral presentation.  The purpose of TranscriptMiner<sup>SM</sup> is for you to find what the judge has said and tailor your arguments and statements to the judge’s preferences. Judges usually don’t appreciate having their own words thrown back at them.
              </li>
              <li>
                You will have access to the prototype for <span>30 days</span> from when the test starts.
              </li>
              </ul>
              <h4><span>THE FUTURE</span></h4>
              <ul>
              <li>
                  The prototype, enhanced by your feedback, will be used as the basis for the first round of external funding.
              </li>
              <li>
                  Once there is “money in the bank”, the following features will be added, and more will be added as they are thought of—and if you think of features you would like to see in the product, please reach out at any time to tell us
                  <a href="mailto:Jeffrey.gettleman@transcriptminer.com">(Jeffrey.gettleman@transcriptminer.com)</a>.
                <ul>
                  <li>
