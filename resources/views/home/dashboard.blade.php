...
@section('title', 'Search Results - TranscriptMinerSM')
@section('content')
                ...
                <form id="core-search-form" class="w-100">
                    ...
                    <div id="search-form-wrapper">
                        <div class="header-center-wrapper">
                            ...
                            <input id="textSearchs" name="searchQuery" type="text" value="{{ $searchQuery ?? '' }}"class="form-control" aria-label="Search anything: judges, parties, opposing counsel, motion types, legal issues" placeholder="Search anything: judges, parties, opposing counsel, motion types, legal issues" autocomplete="off"> 
                            ...
                            <div class="input-group-append">
                                ...
                                <button class="btn btn-search" type="submit" aria-label="search button">
                                    <div class="rINcab searchButtonIcon"> 
                                        <span class="z1asCe MZy1Rb" id="textSearch">
        ...
        <div class="container-fluid search-container">
            <div class="results-container d-flex flex-column justify-content-center align-items-center">
                <div class="main-content-container d-flex flex-row w-100">
                    <div id="sidebar" class="filters-container d-none d-md-block col-sm-3">
                    ...
                    <div id="results-right" class="search-results-container d-flex flex-column col-sm-9">
