            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white">
                <div class="container">
                    <a href="/search" style="margin-right: 5em;">
                        <img src="{{url('uploades/logo.png')}}" >
                        {{-- <img src="/uploads/logo.png" alt="judicial logo" class="judicialLogoImage">  --}}
                    </a>
                    ...
                    <div class="navbar-collapse collapse" id="navbarCollapse">
                        ...
                        <div class="d-block d-md-none nav-item-name"> Stella </div>
                        <ul class="navbar-nav">
                            <li class="nav-item  judicialLinkTheme">
                                <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/search">
                                    Smart Search
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/judges">
                                    Judge Analytics
                                </a>
                           </li>
                            <li class="nav-item  ">
                                <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/ca/motion-type">
                                         Motions & Issues
                                </a>
                            </li>
                        </ul>
                        <div class="ml-auto">
                            <div class="dsk-none">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item">
                                        <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/profile">
                                             Profile
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                         <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/account/overview">
                                            Account Overview
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                            <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/account/overview#ch">
                                                Credit Summary
                                            </a>
                                    </li>
                                    <li class="nav-item">
                                            <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/billing">
                                                Billing
                                            </a>
                                    </li>
                                    <li class="nav-item">
                                            <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/account/history">
                                                Activity History
                                            </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/alerts">
                                            Alerts
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                            <a class="judicialLink internalLinks d-flex flex-grow-1 flex-grow-md-0 align-items-center nav-link" role="button" href="/logout/">
                                                Logout
                                            </a>
                                    </li>
                                </ul>
                                    ...
                                    <li class="nav-item dropdown child-drop">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDocumentation">
                                            <div class="list-group list-group-flush">
                                                 <a class="list-group-item" href="/profile">        Profile
                                                 </a>
                                                  <a class="list-group-item" href="/account/overview">
                                                     Account Overview
                                                  </a>
                                                <a class="list-group-item" href="/account/overview#ch">
                                                    Credit History
                                                </a>
                                                <a class="list-group-item" href="/billing">
                                                    Billing
                                                </a>
                                                <a class="list-group-item" href="/account/history">
                                                    Activity History
                                                </a>
                                                <a class="list-group-item" href="/alerts">
                                                        Alerts
                                                </a>
    ...
    <body>
        ...
        <div class="container footer-container">
            <div class="row justify-content-center justify-content-md-start text-center text-md-left">
                <div class="col-lg-3 ml-lg-auto mb-8 mb-lg-0 text-left"> <img class="brand" src="{{ asset('images/judicial-white-logo.svg') }}" alt="Logo">
                    <ul class="list-inline mb-0 social-footer">
                        <li class="list-inline-item">
                            <a class="btn btn-xs btn-icon btn-soft-secondary rounded" href="https://www.linkedin.com/company/judicial-law" aria-label="Linkedin"> <i class="fab fa-linkedin fa-2x"></i> </a>
                        </li>
                        <li class="list-inline-item">
                            <a class="btn btn-xs btn-icon btn-soft-secondary rounded" href="https://twitter.com/judicial_law" aria-label="Twitter"> <i class="fab fa-twitter fa-2x"></i> </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-6 col-md-3 col-lg text-left">
                    ...
                    <ul class="nav nav-sm nav-x-0 nav-white flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="https://blog.judicial.law/">
                             <span class="media align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://support.judicial.law">
                                <span class="media align-items-center">
                                    <span class="media-body">
                                    Support & FAQ
                                    </span>
